...
return [
    ...
    "between.string" =>
        ":Attribute harus berisi antara :min sampai :max karakter.",
    ...
    "declined_if" =>
        ":Attribute ini harus ditolak ketika :other bernilai :value.",
    ...
    "extensions" =>
        "Bidang :attribute harus memiliki salah satu ekstensi berikut: :values.",
    ...
    "gte.file" =>
        ":Attribute harus berukuran lebih besar dari atau sama dengan :value kilobita.",
    "gte.numeric" =>
        ":Attribute harus bernilai lebih besar dari atau sama dengan :value.",
    "gte.string" =>
        ":Attribute harus berisi lebih besar dari atau sama dengan :value karakter.",
    "hex_color" =>
        "Bidang :attribute harus berupa warna heksadesimal yang valid.",
    ...
    "missing_if" =>
        "Bidang :attribute harus hilang ketika :other adalah :value.",
    "missing_unless" =>
        "Bidang :attribute harus hilang kecuali :other adalah :value.",
    ...
    "password.letters" =>
        ":Attribute ini harus memiliki setidaknya satu karakter.",
    "password.mixed" =>
        ":Attribute ini harus memiliki setidaknya satu huruf kapital dan satu huruf kecil.",
    "password.numbers" =>
        ":Attribute ini harus memiliki setidaknya satu angka.",
    "password.symbols" =>
        ":Attribute ini harus memiliki setidaknya satu simbol.",
    "password.uncompromised" =>
        ":Attribute ini telah muncul di kebocoran data. Silahkan memilih :attribute yang berbeda.",
    "present" => ":Attribute wajib ada.",
    "present_if" => "Bidang :attribute harus ada ketika :other adalah :value.",
    "present_unless" =>
        "Bidang :attribute harus ada kecuali :other adalah :value.",
    ...
    "prohibited_unless" =>
        ":Attribute tidak boleh ada kecuali :other memiliki nilai :values.",
    "prohibits" => ":Attribute melarang isian :other untuk ditampilkan.",
    "regex" => "Format :attribute tidak valid.",
    "relatable" =>
        ":Attribute ini mungkin tidak berasosiasi dengan sumber ini.",
    ...
    "throttle" =>
        "Terlalu banyak upaya masuk. Silahkan coba lagi dalam :seconds detik.",
    ...
    "user" =>
        "Kami tidak dapat menemukan pengguna dengan alamat surel tersebut.",
